...
{
	auto& b = GameScene::instance().getBoard();

	switch (index)
	{
		case 0:
			b.onGetPromotionResult(side, chess::PromotionResult::Knight);
			break;
		case 1:
			b.onGetPromotionResult(side, chess::PromotionResult::Bishop);
			break;
		case 2:
			b.onGetPromotionResult(side, chess::PromotionResult::Rook);
			break;
		case 3:
			b.onGetPromotionResult(side, chess::PromotionResult::Queen);
			break;
		default:
