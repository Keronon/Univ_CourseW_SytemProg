...
{
	return { VertButtonSize.x, (VertButtonSize.y + ButtonSpacing) * count - ButtonSpacing };
}
...
struct SceneManager
{
	...
	/// <summary>
	/// Загрузить сцену по её классу
	/// </summary>
	/// <typeparam name="T">Класс загружаемой сцены</typeparam>
	template<typename T>
